...
\begin{frame}{Il metodo di risoluzione}
    \begin{itemize}
        ...
        \vspace{10px}
        \item \textbf{Insieme di clausole}: notazione insiemistica della \emph{Forma normale congiuntiva} (CNF) di una formula.
        \vspace{10px}
        \item \textbf{Clausola}: disgiunzione di letterali $\Rightarrow$ insieme di letterali.
    \end{itemize}
    \vspace{20px}
